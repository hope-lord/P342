...
def make_bracket(f,a,b,factor,args=None):#bracketting the root
    ...
    if call_func(f,args,a)*call_func(f,args,b)>0:
        ...
        return a,b
#----------------************************--------------------#
def bisection(func,a,b,factor,epsi,args=None): #bisection method and factor is for bracketting
    ...
    if a==None and b==None: return None  #bracketing was not possible
        ...
        return c
#----------------************************--------------------#
def regula_falsi(func,a,b,factor,epsi,args=None):#regula falsi method
    a,b=make_bracket(func,a,b,factor,args)
    if a==None and b==None: return None #bracketing was not possible
    elif a==b: return b  #a or b hits the root
    else:
        ...
        return c
#----------------************************--------------------#
def newton_raphson(f,x0,epsl,args=None):
...
if __name__=="__min__":
    f=lambda x,y: x+y+1
    print(call_func(f,None,1,1))

if __name__=="__ain__":
    from math import sin,cos,log
    f1=lambda x,arg: log(x)-sin(x)+arg
    f2=lambda x,arg: -x-cos(x)

    c=newton_raphson(f1,1.5,0.00001,0)
